 ...
 */
if (!function_exists('wtp_change_gutenberg_color_palette')) {
	function wtp_change_gutenberg_color_palette()
	{
		global $wtp_colors;
		$colors = [];
	...
	add_action('after_setup_theme', 'wtp_change_gutenberg_color_palette');
}
 ...
 */
if (!function_exists('wtp_customizer_colors')) {
 ...
 */
if (!function_exists('wtp_hook_colors_css')) {
	function wtp_hook_colors_css()
	{
		global $wtp_colors;
